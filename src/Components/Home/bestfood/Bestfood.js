...
const Bestfood = () => {
    ...
    useEffect(() => {
        gsap.from(q(".bestfood-title"), { x: 30, duration: 3, scrollTrigger: { trigger: q(".bestfood-title"), start: "-200 bottom" } });
        gsap.from(q(".bestfood-heading"), { x: -30, duration: 3, delay: 1, scrollTrigger: { trigger: q(".bestfood-heading"), start: "-200 bottom" } });
    }, [q])
    return (
